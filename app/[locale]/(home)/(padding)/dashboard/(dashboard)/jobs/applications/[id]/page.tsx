  ...
  return (
    <div className="flex flex-col">
      <Container className="  bg-light">
        <FlexWrapper max={false} className=" justify-center md:justify-between px-0">
          <div className=" flex-1 lg:flex-[60%] flex gap-1 flex-col items-start">
          ...
          <div className=" w-full sm:flex-row flex-col flex-1 lg:flex-[40%] flex items-center gap-3">
            <FunctionalButton className=" rounded-2xl w-full" btnText="Edit" icon={<EditIcon />} link="#" />
            <TooltipProvider>
              <div className=" flex items-center gap-2">
                <Tooltip>
