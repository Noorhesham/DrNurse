...
const ModalCustom = forwardRef<HTMLButtonElement, any>(
  (
    {
      btn,
      content,
    ...
    return (
      <Dialog open={open} onOpenChange={setCustomModal || setOpen}>
          ...
          {(cancelBtn || functionalbtn || desc) && (
            <DialogFooter className="pb-10 flex items-center sm:flex-col">
              <div className="flex gap-2 items-center">
                ...
                <DialogClose ref={ref} className="mx-auto flex items-center gap-5">
                  {cancelBtn && (
                    <Button
                      type="button"
